                        ...
                        <div class="sidebar__item">
                            ...
                            <div class="price-range-wrap">
                                <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"
                                    ...
                                    <span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default minRange"></span>
                                    <span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default maxRange"></span>
                                </div>
                                <div class="range-slider">
                                    <div class="price-input">
                                        <form style="color:red;font-weight:bold;" action="{{route('priceFilter')}}" method="POST" id="searchForm">
                                            @csrf
                                        $<input type="text" id="minamount" name="min">
                                        $<input type="text" id="maxamount" class="maxamount" name="max">
                                    </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span id="count"><?php echo App\Models\Product::where('discount',null)->count()?></span> Products found</h6>
                                </div>
                            </div>
