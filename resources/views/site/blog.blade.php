...
<?php endif?>">
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <div class="blog__sidebar__recent">
                                ...
                                <a href="{{route('blogView',['id' => $blog->id])}}" class="blog__sidebar__recent__item">
                        ...
                        <div class="blog__sidebar__item">
                            ...
                            <div class="blog__sidebar__item__tags">
                                ...
                                <a href="/blog/category/{{$category->name}}">{{$r->name}}</a>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                <div class="blog__item__pic">
                                    <img style="width:200px;height:300px;" src="{{asset('blog_image/'.$blog->image)}}" alt="">
                                </div>
